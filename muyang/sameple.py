...
end_date = "2018-08-04"
bt_id = "c12ceac0683e86dd1aad56a6f0c95e98"
...
for i in range(0, len(df)):
    ...
    if(len(lst) < 19):
        ...
        out_price_list.append(float("Nan"))
    else:
        if(len(N) == 0):
        ...
        out_price_list.append(cur_max_out_price)
...
df['ma12'] = pd.Series(out_price_list,index=df.index.values)
